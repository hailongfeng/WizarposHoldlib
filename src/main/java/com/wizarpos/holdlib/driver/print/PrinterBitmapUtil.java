...
//        PrinterInterface.write(new byte[]{0x1B, 0x21, 0},3);
//        PrinterInterface.write("\n\n\n".getBytes(),3);
//      PrinterInterface.write(new byte[]{0x1B, 0x4A, 8},3);
//        // reset the printer
//        PrinterInterface.write(new byte[]{0x1B, 0x40},2);
...
//        PrinterInterface.PrinterClose();
    ...
    public static void printBitmapGSVMSB(Bitmap bm, int bitMarginLeft, int bitMarginTop) {
		...
		// Log.e("-----","PBU183 "+result );
		int resultP = PrinterInterface.open();
		...
		resultP = PrinterInterface.begin();
		...
		PrinterInterface.write(result, result.length);
		PrinterInterface.write(PrinterCommand.getCmdEscDN(2), PrinterCommand.getCmdEscDN(2).length);
		
		// PrinterInterface.write(new byte[]{0x12, 0x54},2);
